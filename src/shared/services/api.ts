...
function buildApiError(data: any, fallbackMessage = 'Erro na requisicao.') {
  const message =
    typeof data === 'object' && data
      ? data.erro || data.detail || fallbackMessage
      : fallbackMessage;

  const error = new Error(message) as Error & { data?: any };
...
export const municipiosApi = {
  ...
  atualizar: (id: number | string, data: any) =>
    apiFetch<any>(`/municipios/${id}/`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const upasApi = {
  ...
  atualizar: (id: number | string, data: any) =>
    apiFetch<any>(`/upas/${id}/`, { method: 'PUT', body: JSON.stringify(data) }),
};
...
export const medicosApi = {
  ...
  atualizar: (id: number | string, data: any) =>
    apiFetch<any>(`/medicos/${id}/`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const turnosApi = {
  ...
  meuHistorico: () => apiFetch<any>('/turnos/meu/historico/'),
  ...
  encerrar: (data?: { turno_id?: number | string; encerrado_em?: string }) =>
